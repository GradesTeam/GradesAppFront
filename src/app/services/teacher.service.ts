...
export class TeacherService {
  ...
  createTeacher(username: any, email: any, password: any, repeatPassword: any, titulacion: any, name: any, surname: any): Observable<TeacherResponse> {
    return this.http.post<TeacherResponse>(`${environment.apiBaseUrl}profesor/register`,
      {
        "username": username,
        "nombre": name,
        "apellidos": surname,
